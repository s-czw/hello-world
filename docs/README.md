...
**Locked decisions:** TypeScript end-to-end (Next.js + NestJS + PostgreSQL + Redis) · Docker Compose self-hosted · MVP in 6 weeks (3 × 2-week sprints, 20 Jul – 28 Aug 2026) including both core work management and the portfolio layer · 4-week pilot from 31 Aug.
...
| [02-architecture.md](02-architecture.md) | Tech Lead | Monorepo & module architecture, full ERD, API design, auth with an Entra-SSO drop-in seam, SSE realtime with pre-agreed cut, storage, non-functionals, Docker Compose deployment, testing strategy, technical risks |
